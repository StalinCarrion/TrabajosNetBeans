...
public class frmUsuarioLogin extends javax.swing.JFrame {
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        try {
            ...
            dts.setStrLogin_us(txtUsuario.getText());
            dts.setStrUs_password(txtPassword.getText());
            
            modelo = func.login(dts.getStrLogin_us());

            tablalistado.setModel(modelo);
            
            String valor = tablalistado.getValueAt(0, 3).toString();
         

            if (txtPassword.getText() == func.desencriptar( valor, "st") ) {
            ...
            if (func.totalregistros > 0) {
                ...
                frmInicio.lblNombreUsuario.setText(tablalistado.getValueAt(0, 1).toString());
                frmInicio.lblLogin.setText(tablalistado.getValueAt(0, 2).toString());
                frmInicio.lblNombreRol.setText(tablalistado.getValueAt(0, 4).toString());
                frmInicio.lblNombreFuncionalidad.setText(tablalistado.getValueAt(0, 5).toString());

                /*if (!frmInicio.lblNombreFuncionalidad.getText().equals("Administrador")) {
