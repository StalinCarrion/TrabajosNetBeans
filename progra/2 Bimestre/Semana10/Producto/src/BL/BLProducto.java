...
public class BLProducto {
    ...
    public Productos Consultar(int p_unitario) throws ClassNotFoundException, SQLException 
    {
        Productos objProd = new Productos();
        ResultSet rsProd = mp.Consultar(p_unitario);
        while (rsProd.next()){
            objProd.setStrCodigo(rsProd.getString("codigo"));
            objProd.setStrDescripcion(rsProd.getString("descripcion"));
            objProd.setIntCantidad(Integer.parseInt(rsProd.getString("cantidad")));
            objProd.setIntPrecioU(Integer.parseInt(rsProd.getString("p_unitario")));
            objProd.setIntPVP(Integer.parseInt(rsProd.getString("pvp")));
            objProd.setStrFechaIngreso(rsProd.getString("fecha_ingreso"));
            objProd.setStrFechaM(rsProd.getString("fecha_modificacion"));
